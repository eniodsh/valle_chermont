<?php
	...
	class XlsHelper extends AppHelper {
	    ...
	    function setHeader($filename) {
	        CakeResponse::header("Pragma: public");
			CakeResponse::header("Expires: 0");
			CakeResponse::header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
			CakeResponse::header("Content-Type: application/vnd.ms-excel; charset=UTF-8");
			CakeResponse::header("Content-Type: application/force-download");
			CakeResponse::header("Content-Type: application/download");;
			//header("Content-Disposition: inline; filename=\"".$filename.".xls\"");
			// Name the file to .xlsx to solve the excel/openoffice file opening problem
			CakeResponse::header("Content-Disposition: inline; filename=\"".$filename.".xlsx\"");
	    }
