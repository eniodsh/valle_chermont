			    ...
			    <ul>
			      <li class="has-dropdown">
			        ...
			        <ul class="dropdown">
						...
						<li><?php echo $this->Html->link('Nossa Cidade', '/pages/nossa-cidade', array('class' => $this->request->params['action'] == 'index' && $this->request->params['controller'] == 'nossa-cidade' ? 'nossa-cidade' : '')); ?></li>
